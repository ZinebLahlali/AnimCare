                            ...
                            <div class="flex gap-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex flex-col justify-between">
                                        ...
                                        <span class="text-xs bg-blue-100 text-purple-500 px-2 py-1 rounded-full">Species: {{$animal->species}}</span>
                                    </div>
                                    <p class="text-sm text-gray-500">Age: {{$animal->age}}. Years old</p>
                                </div>
                            </div>
                            <div class="mt-4 pt-4 border-t border-gray-100 flex gap-2">
                                <button class="flex-1 py-1.5 text-sm font-medium border border-blue-200 text-purple-500 rounded-lg">View Health</button>
                            </div>
                            @endforeach
                        </div>

                      
                        <button class="border-2 border-dashed border-blue-200 rounded-xl flex flex-col items-center justify-center p-6 text-purple-500 hover:bg-blue-50 gap-2">
                    ...
                    <div class="col-span-2 flex flex-col gap-6">
                        <div>
                            <h3 class="text-lg font-semibold mb-4 flex items-center gap-2">
                                <span class="material-symbols-outlined text-purple-500">event_upcoming</span>
                            ...
                            <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                                ...
                                <div class="p-4 flex items-center gap-4 border-b border-gray-100">
                                    <div class="bg-blue-100 text-purple-500 px-3 py-2 rounded-lg text-center w-16">
                                        <p class="text-xs font-bold uppercase">Oct</p>
                                        <p class="text-xl font-bold">12</p>
                                    </div>
                                    <div class="flex-1">
                                        <p class="font-semibold">Annual Checkup - Buddy</p>
                                        <p class="text-sm text-gray-500">10:30 AM &nbsp;•&nbsp; Dr. Sarah Smith</p>
                                    </div>
